...
export default function City1() {
    return(
        <div>
            <h1 className="font-bold text-center underline text-3xl">Honda City 2024 Price in Pakistan, Images, Reviews & Specs</h1>
              <div className="flex w-3/12 m-4 m-auto"><Image src={city} alt="corolla" width={150} height={150} className="w-[200px] h-[200px]"></Image></div>      
