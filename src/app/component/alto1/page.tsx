...
export default function Alto1() {
    return(
        <div>
            <h1 className="font-bold text-center underline text-3xl">Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs</h1>
              <div className="flex w-3/12 m-4 m-auto"><Image src={alto} alt="corolla" width={150} height={150} className="w-[200px] h-[200px]"></Image></div>      
        ...
        <Link href="/component/checkout"></Link>
